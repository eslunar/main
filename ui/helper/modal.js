function Modal(child,css={}){
  this.element=new Element(`<modal uuid="${app.uuid(100)}" style="background:#00000025;top:0;left:0;width:100vw;height:100vh;z-index:3;position:fixed;display:flex;align-items:center;align-content:center;justify-content:center;"></modal>`).css(css)
